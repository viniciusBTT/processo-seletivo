 ...
 *   https://datatables.net/download/#bs5/jq-3.7.0/dt-1.13.6/fh-3.4.0/r-2.5.0/sb-1.5.0
 *
 * Included libraries:
 *   jQuery 3 3.7.0, DataTables 1.13.6, FixedHeader 3.4.0, Responsive 2.5.0, SearchBuilder 1.5.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs5/jq-3.7.0/dt-1.13.6/fh-3.4.0/r-2.5.0/sb-1.5.0",
